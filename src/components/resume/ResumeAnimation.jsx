...
const resumeContent = [
  {
    ...
    jobDescription: `Developing and designing the front-end layout of the company website, 
    utilizing ReactJS, NextJS tools and edit the website to meet company expectations.`,
    delayAnimation: "",
  },
  {
    ...
    jobDescription: `Developing and designing android layout using java, kotlin and firebase for databases.`,
    delayAnimation: "100",
  },
  {
    ...
    timeDuraton: `Full Time`,
    compnayName: "Indonesian Young Scientist Association ( IYSA )",
    jobDescription: `Maintenance hardware, Wireless Security, Network Security, Linux, Troubleshooting, 
    Domain Name System (DNS), Ipv4, Backup.  `,
    delayAnimation: "200",
  },
];
